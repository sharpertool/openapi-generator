 ...
 * 1) Set a break point in NodeExpressPeiGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class NodeJSExpressServerPeiGeneratorTest {
...
//              .setGeneratorName("node-express-pei") // use this codegen library
...
//              .setOutputDir("out/node-express-pei"); // output directory
//
